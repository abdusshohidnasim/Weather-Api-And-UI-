...
//
//     final fristpage = fristpageFromJson(jsonString);
...
class Condition {
  ...
  Condition({required this.texte, required this.icon, required this.code});

  factory Condition.fromJson(Map<String, dynamic> json) => Condition(
    texte: textValues.map[json["text"]]!,
    icon: iconValues.map[json["icon"]]!,
    code: json["code"],
  );

  Map<String, dynamic> toJson() => {
    "text": textValues.reverse[texte],
...
enum Texte { CLEAR, SUNNY }

final textValues = EnumValues({"Clear ": Texte.CLEAR, "Sunny": Texte.SUNNY});

enum WindDir { N, NNW, NW, WNW }
